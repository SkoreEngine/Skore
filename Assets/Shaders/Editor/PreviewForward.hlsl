...
#include "Skore://Shaders/GlobalBindings.hlsli"
#include "Skore://Shaders/Lights.hlsli"
#include "Skore://Shaders/MaterialSurface.hlsli"
...
float4 MainPS(PixelInput input) : SV_Target0
{
	...
	//the preview pipeline renders straight to a display target with no post-process pass, so tonemap inline
