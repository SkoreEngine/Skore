...
namespace Skore
{
    ...
    namespace Event
    {
        SK_API void                 Bind(TypeID typeId, VoidPtr userData, VoidPtr instance, FnEventCallback eventCallback);
        SK_API void                 Unbind(TypeID typeId, VoidPtr userData, VoidPtr instance, FnEventCallback eventCallback);
        SK_API usize                EventCount(TypeID typeId);
        SK_API EventTypeData*       GetData(TypeID typeId);
        SK_API void                 InvokeEvents(EventTypeData* eventTypeData, VoidPtr* parameters);
