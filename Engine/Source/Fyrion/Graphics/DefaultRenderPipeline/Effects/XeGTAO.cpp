...
namespace Fyrion
{
    ...
    struct XeGTADenoisePass : RenderGraphPassHandler
    {
        ...
        void Init() override
        {
            ShaderState* csDenoisePass = Assets::LoadByPath<ShaderAsset>("Fyrion://Shaders/Effects/XeGTAO/vaGTAO.comp")->GetState("CSDenoisePass");
            ShaderState* csDenoiseLastPass = Assets::LoadByPath<ShaderAsset>("Fyrion://Shaders/Effects/XeGTAO/vaGTAO.comp")->GetState("CSDenoiseLastPass");
