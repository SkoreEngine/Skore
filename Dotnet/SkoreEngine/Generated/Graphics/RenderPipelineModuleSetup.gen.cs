...
{
    public partial class RenderPipelineModuleSetup : IDisposable
    {
        public IntPtr Handle;
        private IntPtr __owned;

        internal unsafe struct __Storage { private fixed byte _data[112]; }

        public RenderPipelineModuleSetup(IntPtr handle) { Handle = handle; }
        internal RenderPipelineModuleSetup(IntPtr handle, IntPtr ownedType) { Handle = handle; __owned = ownedType; }
        ...
        static RenderPipelineModuleSetup()
        {
            var __rt = Reflection.FindTypeByName("Skore::RenderPipelineModuleSetup")!.Value;
        ...
        public unsafe ReadOnlySpan<Skore.TypeId> Passes
        {
