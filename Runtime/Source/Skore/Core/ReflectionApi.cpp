...
namespace Skore
{
	namespace
	{
		...
		const ReflectionApi api = {
			...
			.RegisterType = [](StringView name, StringView simpleName, const TypeProps* props) { return Reflection::RegisterType(name, simpleName, *props).GetHandle(); },

			.TypeBuilderAddField = [](ReflectTypeBuilder builder, const FieldProps* props, StringView name) { return builder.AddField(*props, name).GetHandle(); },
			.TypeBuilderAddFunction = [](ReflectTypeBuilder builder, StringView name) { return builder.AddFunction(name).GetHandle(); },
			.TypeBuilderAddConstructor = [](ReflectTypeBuilder builder, FieldProps* props, StringView* names, u32 size) { return builder.AddConstructor(props, names, size).GetHandle(); },
			.TypeBuilderAddAttribute = [](ReflectTypeBuilder builder, const TypeProps* props) { return builder.AddAttribute(*props).GetHandle(); },
			.TypeBuilderAddValue = [](ReflectTypeBuilder builder, StringView valueDesc) { return builder.AddValue(valueDesc).GetHandle(); },
			...
			.FieldBuilderAddAttribute = [](ReflectFieldBuilder builder, const TypeProps* props) { return builder.AddAttribute(*props).GetHandle(); },
			...
			.FunctionBuilderAddAttribute = [](ReflectFunctionBuilder builder, const TypeProps* props) { return builder.AddAttribute(*props).GetHandle(); },
