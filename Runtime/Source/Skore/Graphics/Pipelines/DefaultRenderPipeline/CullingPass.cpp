...
namespace Skore
{
	RenderPipelinePassSetup CullingPass::GetPassSetup()
	{
	...
	void CullingPass::CreateDescriptorSet()
	{
	...
	void CullingPass::PrepareBuffers(Scene* scene, SceneCullingData* data)
	{
	...
	void CullingPass::Render(Scene* scene, GPUCommandBuffer* cmd)
	{
