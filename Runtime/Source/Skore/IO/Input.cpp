...
namespace Skore
{
	...
	namespace
	{
		...
		CursorLockMode                                       currentCursorLockMode = CursorLockMode::Free;
	...
	bool Input::IsAnyMouseDown()
	{
		...
		{
			if (mouseButtonState[i]) return true;
		}
		return false;
	}
	...
	void Input::SetCursorLockMode(CursorLockMode cursorLockMode)
	{
		...
		Platform::SetWindowCursorLockMode(Graphics::GetWindow(), cursorLockMode);
	}
	...
	{
		return mouseRelativePosition * 0.1;
	}
